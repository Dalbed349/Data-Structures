...
async.eachSeries(addressesForDb, function(value, callback) {
    ...
    client.connect();
    var thisQuery = "INSERT INTO aalocations VALUES (E'" + value.StreetAddress.StreetAddress + "', "+ value.LatLong[0]+ ", " + value.LatLong[1] + ");";  //"+value.City+", "+value.State+", "+value.Zip+","+value.StreetAddress.City+",
