...
let GeoCodes = fs.readFileSync('/home/ec2-user/environment/WeeklyAssignment7/Geocodes/map10geo.json');

let GeoCode = JSON.parse(GeoCodes);

let map1 = fs.readFileSync('/home/ec2-user/environment/WeeklyAssignment7/data/map10.json');
...
fs.writeFileSync("/home/ec2-user/environment/WeeklyAssignment7/CombinedOutputs/Map10Combined.json", JSON.stringify(map1AddGeo))
