...
let GeoCodes = fs.readFileSync('/home/ec2-user/environment/WeeklyAssignment7/Geocodes/map6geo.json');

let GeoCode = JSON.parse(GeoCodes);

let map1 = fs.readFileSync('/home/ec2-user/environment/WeeklyAssignment7/data/map6.json');
...
fs.writeFileSync("/home/ec2-user/environment/WeeklyAssignment7/CombinedOutputs/Map6Combined.json", JSON.stringify(map1AddGeo))
